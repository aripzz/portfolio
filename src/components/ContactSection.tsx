...
const SocialIcons = (): React.ReactElement => (
    <div className="flex gap-4">
        <a
            ...
            aria-label="LinkedIn"
            className="text-terang hover:text-white"
        >
...
export default function ContactSection(): React.ReactElement {
    ...
    return (
        <section id="contact" className="max-w-3xl mx-auto px-6 py-16">
            <h2 className="text-3xl font-extrabold mb-2 text-terang">Hubungi Saya</h2>
            <p className="text-terang/70 mb-6">Untuk pertanyaan kerja sama, silakan kirim email atau gunakan formulir kontak.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-sekunder/20 border border-sekunder/40 backdrop-blur-sm p-6 rounded-lg shadow-lg">
                <div>
                    <label htmlFor="name" className="block text-sm font-medium mb-1 text-terang">
                        Nama
                    </label>
                    <input
                        id="name"
                        ...
                        className={`w-full rounded-md border px-3 py-2 bg-transparent placeholder:text-terang/50 text-terang focus:outline-none focus:ring-2 focus:ring-[#00ADB5] border-sekunder/60 ${fieldErrors.name ? 'ring-2 ring-red-600/50' : ''}`}
                ...
                <div>
                    <label htmlFor="email" className="block text-sm font-medium mb-1 text-terang">
                        Email
                    </label>
                    <input
                        id="email"
                        ...
                        className={`w-full rounded-md border px-3 py-2 bg-transparent placeholder:text-terang/50 text-terang focus:outline-none focus:ring-2 focus:ring-[#00ADB5] border-sekunder/60 ${fieldErrors.email ? 'ring-2 ring-red-600/50' : ''}`}
                        placeholder="you@example.com"
                        required
                    />
                    <p id="email-help" className="mt-1 text-xs text-terang/60">Saya akan membalas ke alamat ini.</p>
                    {fieldErrors.email && <p id="email-error" className="mt-1 text-xs text-red-400">{fieldErrors.email}</p>}
                </div>

                <div>
                    <label htmlFor="message" className="block text-sm font-medium mb-1 text-terang">
                        Pesan
                    </label>
                    <textarea
                        id="message"
                        ...
                        className={`w-full rounded-md border px-3 py-2 h-36 resize-y bg-transparent placeholder:text-terang/50 text-terang focus:outline-none focus:ring-2 focus:ring-[#00ADB5] border-sekunder/60 ${fieldErrors.message ? 'ring-2 ring-red-600/50' : ''}`}
                ...
                {/* Footer: social icons */}
                <footer className="mt-4 border-t border-sekunder/40 pt-4">
                    <p className="text-sm mb-3 text-terang/70">Atau temukan saya di:</p>
                    <SocialIcons />
                </footer>
            </form>
        </section>
