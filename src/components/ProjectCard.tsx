...
export default function ProjectCard({ project, onOpen }: { project: Project; onOpen?: (p: Project) => void }) {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-utama/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
