...
export default function Lightbox({ project, onClose }: { project: Project; onClose: () => void }) {
  ...
  return (
    <div id="lightbox" className="fixed inset-0 z-[100] bg-utama/95 flex-col items-center justify-center p-4 md:p-10 flex">
      ...
      <div className="max-w-5xl w-full flex flex-col md:flex-row gap-8 items-center">
        ...
        <div className="w-full md:w-1/3 text-[#EEEEEE]">
          ...
          <p className="text-[#EEEEEE]/70 leading-relaxed mb-8">{project.description}</p>
          <div className="flex flex-col gap-3">
            ...
            <button onClick={() => {}} className="w-full border border-sekunder hover:bg-sekunder text-[#EEEEEE] py-3 rounded-md font-bold transition text-sm">Lihat Kajian Kes</button>
          </div>
        </div>
      </div>
    </div>
